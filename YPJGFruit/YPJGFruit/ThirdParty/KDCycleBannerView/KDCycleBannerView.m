...
@property (strong, nonatomic) CWPageControl *pageControl;
...
- (void)initializePageControl {
    ...
    _pageControl = [[CWPageControl alloc] initWithFrame:pageControlFrame];
    _pageControl.center = CGPointMake(CGRectGetWidth(_scrollView.frame)*0.5, CGRectGetHeight(_scrollView.frame) - 14.);
    _pageControl.userInteractionEnabled = NO;
#pragma mark - 修改颜色
    _pageControl.currentPageIndicatorTintColor=self.currentPageIndicatorTintColor?self.currentPageIndicatorTintColor:[UIColor greenColor];
