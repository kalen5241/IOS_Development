...
-(void)setXLabels:(NSArray *)xLabels
{
   ...
   // num = xLabels.count + 1;
    ...
    for (int i=0; i<xLabels.count; i++) {
        UUChartLabel * label = [[UUChartLabel alloc] initWithFrame:CGRectMake((i *  _xLabelWidth ), self.frame.size.height - UULabelHeight, _xLabelWidth + 2, UULabelHeight)];
        
//        if (i%5 == 0 || i == xLabels.count - 1) {
